...
const FooterConst = () => {
  return (
    <div className="w-100 justify-content-center d-flex m-0 d-footer flex-column align-items-center text-center">
      <Container
        className="h-auto text-center w-100 footer m-0 p-0 pt-4 pb-4"
        static="bottom"
      >
        <Row className="w-100 justify-content-center" md={4}>
          <Row md={12}>
            ...
            <Col md={12} xs={12} sm={4}>
              <Link
                to="https://santateresa.ifes.edu.br/index.php/noticias"
                className="text-decoration-none"
                data-test=""
                target="_blank"
              >
          ...
          <Row md={12}>
            <Col md={12} sm={4} className="comunidade">
              <h6>Comunidade</h6>
            </Col>
            <Col md={12} xs={12} sm={2}>
              <Link
                to="https://github.com/LuizM3/NutriFood"
                className="text-decoration-none"
                data-test=""
                target="_blank"
              >
            ...
            <Col md={12} xs={12} sm={2}>
              <Link
                to="https://web.facebook.com/?locale=pt_BR&_rdc=1&_rdr"
                className="text-decoration-none"
                data-test=""
                target="_blank"
              >
            ...
            <Col md={12} xs={12} sm={2}>
              <Link
                to="https://www.paypal.com/br/home"
                className="text-decoration-none"
                data-test=""
                target="_blank"
              >
