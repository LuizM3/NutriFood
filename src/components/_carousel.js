...
const Carrossel = () => {
  return (
    ...
    <Carousel fade className='carousel'>
      ...
      <h1 className='tittleCar'>Avalie nossa comida
      <Button className='bt-car'>Saiba mais</Button></h1>
      </Carousel.Item>

      <Carousel.Item id="day3">
      <h1 className='tittleCar'>Sugira uma refeição
      <Button className='bt-car'>Saiba mais</Button></h1>
      </Carousel.Item>

      <Carousel.Item id="day4">
      <h1 className='tittleCar'>Cardápio do dia
      <Button className='bt-car'>Saiba mais</Button></h1>
      </Carousel.Item>

      <Carousel.Item id="day5">
      <h1 className='tittleCar'>Contate-nos
      <Button className='bt-car'>Saiba mais</Button></h1>
      </Carousel.Item>
    </Carousel>
